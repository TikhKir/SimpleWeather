...
import com.example.simpleweather.data.network.locationiq.rawmodel.RawLocation
...
interface LocationIqService {
    ...
    @GET("reverse.php") //this method must return a list of nearby locations, but locationIQ still not support this feature =(
